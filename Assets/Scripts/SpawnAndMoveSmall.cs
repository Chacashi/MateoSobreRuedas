...
public class SpawnAndMoveSmall : MonoBehaviour
{
    ...
    [Header("Posiciones")]
    public Transform spawnPoint;   // Posición inicial
    public Transform targetPoint;  // Posición final
    ...
    private Vector3 startScale = new Vector3(0.1257591f, 0.1220184f, 1f);
    private Vector3 endScale = new Vector3(0.2835868f, 0.3462395f, 1f);
